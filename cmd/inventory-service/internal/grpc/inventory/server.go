...
func Register(gRPCServer *grpc.Server, invent Inventory) {
	inventory.RegisterInventoryServer(gRPCServer, &serverAPI{inventory: invent})
}
...
func (s *serverAPI) AddGood(ctx context.Context, in *inventory.AddGoodRequest) (*inventory.AddGoodResponse, error) {
	...
	if err := s.inventory.AddGood(ctx, in.Name, in.Description, in.ImageLink, int(in.Price), int(in.QuantityInStock)); err != nil {
...
func (s *serverAPI) ListProducts(ctx context.Context, in *inventory.ListProductsRequest) (*inventory.ListProductsResponse, error) {
	goods, err := s.inventory.ListProducts(ctx)
	if err != nil {
...
func (s *serverAPI) DeleteGood(ctx context.Context, in *inventory.DeleteGoodRequest) (*inventory.DeleteGoodResponse, error) {
	...
	if err := s.inventory.DeleteGood(ctx, good_id); err != nil {
...
func (s *serverAPI) UpdateGood(ctx context.Context, in *inventory.UpdateGoodRequest) (*inventory.UpdateGoodResponse, error) {
	...
	if err := s.inventory.UpdateGood(ctx, good_id, in.Name, in.Description, in.ImageLink, int(in.Price), int(in.QuantityInStock)); err != nil {
